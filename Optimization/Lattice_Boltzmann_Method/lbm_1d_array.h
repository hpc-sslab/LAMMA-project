...
#define LOCAL(g,e)       (GRID_ENTRY_SWEEP( g,  0,  0,  0, e )) //calculate the index in grid at x,y,z with direction e
#define NEIGHBOR_C(g,e)  (GRID_ENTRY_SWEEP( g,  0,  0,  0, e )) //0
#define NEIGHBOR_N(g,e)  (GRID_ENTRY_SWEEP( g,  0, +1,  0, e )) //1
#define NEIGHBOR_S(g,e)  (GRID_ENTRY_SWEEP( g,  0, -1,  0, e )) //2
#define NEIGHBOR_E(g,e)  (GRID_ENTRY_SWEEP( g, +1,  0,  0, e )) //3
#define NEIGHBOR_W(g,e)  (GRID_ENTRY_SWEEP( g, -1,  0,  0, e )) //4
#define NEIGHBOR_T(g,e)  (GRID_ENTRY_SWEEP( g,  0,  0, +1, e )) //5
#define NEIGHBOR_B(g,e)  (GRID_ENTRY_SWEEP( g,  0,  0, -1, e )) //6
#define NEIGHBOR_NE(g,e) (GRID_ENTRY_SWEEP( g, +1, +1,  0, e )) //7
#define NEIGHBOR_NW(g,e) (GRID_ENTRY_SWEEP( g, -1, +1,  0, e )) //8
#define NEIGHBOR_SE(g,e) (GRID_ENTRY_SWEEP( g, +1, -1,  0, e )) //9
#define NEIGHBOR_SW(g,e) (GRID_ENTRY_SWEEP( g, -1, -1,  0, e )) //10
#define NEIGHBOR_NT(g,e) (GRID_ENTRY_SWEEP( g,  0, +1, +1, e )) //11
#define NEIGHBOR_NB(g,e) (GRID_ENTRY_SWEEP( g,  0, +1, -1, e )) //12
#define NEIGHBOR_ST(g,e) (GRID_ENTRY_SWEEP( g,  0, -1, +1, e )) //13
#define NEIGHBOR_SB(g,e) (GRID_ENTRY_SWEEP( g,  0, -1, -1, e )) //14
#define NEIGHBOR_ET(g,e) (GRID_ENTRY_SWEEP( g, +1,  0, +1, e )) //15
#define NEIGHBOR_EB(g,e) (GRID_ENTRY_SWEEP( g, +1,  0, -1, e )) //16
#define NEIGHBOR_WT(g,e) (GRID_ENTRY_SWEEP( g, -1,  0, +1, e )) //17
#define NEIGHBOR_WB(g,e) (GRID_ENTRY_SWEEP( g, -1,  0, -1, e )) //18
...
/*############################################################################*/
//by myself
#define CALC_INDEX_SOA_W_STRUCT(x,y,z,e) (x + ((y + z*SIZE_YY)*SIZE_XX))// + (SIZE_X*SIZE_Y)*SIZE_Z*e)
//#define CALC_INDEX_SOA_WO_STRUCT(x,y,z,e) (x + ((y + z*SIZE_YY)*SIZE_XX))// + (SIZE_X*SIZE_Y)*SIZE_Z*e)
#define CALC_INDEX_SOA_WO_STRUCT(x,y,z,e) (x + ((y + z*SIZE_Y)*SIZE_X))// + (SIZE_X*SIZE_Y)*SIZE_Z*e)
#define U2(ux,uy,uz) (1.5*(ux*ux+uy*uy+uz*uz))
