...
%title(['Rate of convergence is Ch^{' num2str(r3,2) '}'],'FontSize', 14);
h_legend = legend(str1,['C_1h^{' num2str(r1,2) '}'],...
                  str2,['C_2h^{' num2str(r2,2) '}'],...
                  str3,['C_3h^{' num2str(r3,2) '}'],'LOCATION','Best');
