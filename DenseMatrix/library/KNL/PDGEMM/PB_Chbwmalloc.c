...
#include "../PBblacs.h"
#include "../PBblas.h"
#include "/home01/x2047a02/include/include/hbwmalloc.h"

#ifdef __STDC__
char * PB_Chbwmalloc( int LENGTH )
#else
char * PB_Chbwmalloc( LENGTH )
/*
*  .. Scalar Arguments ..
*/
   int            LENGTH;
...
*  =======
*
*  PB_Chbwmalloc allocates a dynamic memory buffer. In case of failure, the
...
*/
   if( LENGTH > 0 )
   {
      if( !( bufptr = (char *) hbw_malloc( (unsigned)LENGTH ) ) )
      {
