...
void micro_kernel0(int k, const double * A, const double * B, double * C, int ncol)
{
  ...
  for(i=0; i<k ; i++)
  {
    ...
    _C0_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[0]), _A0, _C0_0);
    _C1_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[1]), _A0, _C1_0);
    _C2_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[2]), _A0, _C2_0);
    _C3_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[3]), _A0, _C3_0);
    _C4_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[4]), _A0, _C4_0);
    _C5_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[5]), _A0, _C5_0);
    _C6_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[6]), _A0, _C6_0);
    _C7_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[7]), _A0, _C7_0);
    _C8_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[8]), _A0, _C8_0);
    _C9_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[9]), _A0, _C9_0);
    _C10_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[10]), _A0, _C10_0);
    _C11_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[11]), _A0, _C11_0);
    _C12_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[12]), _A0, _C12_0);
    _C13_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[13]), _A0, _C13_0);
    _C14_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[14]), _A0, _C14_0);
    _C15_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[15]), _A0, _C15_0);
    _C16_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[16]), _A0, _C16_0);
    _C17_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[17]), _A0, _C17_0);
    _C18_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[18]), _A0, _C18_0);
    _C19_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[19]), _A0, _C19_0);
    _C20_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[20]), _A0, _C20_0);
    _C21_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[21]), _A0, _C21_0);
    _C22_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[22]), _A0, _C22_0);
    _C23_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[23]), _A0, _C23_0);
    _C24_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[24]), _A0, _C24_0);
    _C25_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[25]), _A0, _C25_0);
    _C26_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[26]), _A0, _C26_0);
    _C27_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[27]), _A0, _C27_0);
    _C28_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[28]), _A0, _C28_0);
    _C29_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[29]), _A0, _C29_0);
    _C30_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[30]), _A0, _C30_0);
    A += MR;
    B += NR;
  }
  // store _C -> C
