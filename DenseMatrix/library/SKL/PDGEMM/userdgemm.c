...
void micro_kernel0(int k, const double * A, const double * B, double * C, int ncol)
{
  ...
  for(i=0; i<k ; i++)
  {
    ...
    _C0_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[0]), _A1, _C0_1);
    _C1_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[1]), _A0, _C1_0);
    _C1_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[1]), _A1, _C1_1);
    _C2_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[2]), _A0, _C2_0);
    _C2_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[2]), _A1, _C2_1);
    _C3_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[3]), _A0, _C3_0);
    _C3_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[3]), _A1, _C3_1);
    _C4_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[4]), _A0, _C4_0);
    _C4_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[4]), _A1, _C4_1);
    _C5_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[5]), _A0, _C5_0);
    _C5_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[5]), _A1, _C5_1);
    _C6_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[6]), _A0, _C6_0);
    _C6_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[6]), _A1, _C6_1);
    _C7_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[7]), _A0, _C7_0);
    _C7_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[7]), _A1, _C7_1);
    _C8_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[8]), _A0, _C8_0);
    _C8_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[8]), _A1, _C8_1);
    _C9_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[9]), _A0, _C9_0);
    _C9_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[9]), _A1, _C9_1);
    _C10_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[10]), _A0, _C10_0);
    _C10_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[10]), _A1, _C10_1);
    _C11_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[11]), _A0, _C11_0);
    _C11_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[11]), _A1, _C11_1);
    _C12_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[12]), _A0, _C12_0);
    _C12_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[12]), _A1, _C12_1);
    _C13_0 = _mm512_fmadd_pd(_mm512_set1_pd(B[13]), _A0, _C13_0);
    _C13_1 = _mm512_fmadd_pd(_mm512_set1_pd(B[13]), _A1, _C13_1);
    A += MR;
    B += NR;
  }
  // store _C -> C
		...
		double       *bk) // to *bk
{
	...
	int i, j;
	register __m512d x0,x00, x1, x11;
...
/*			x0 = _mm512_loadu_pd(&mt[i*inc+j*MR]);
			x00 = _mm512_loadu_pd(&mt[i*inc+j*MR+8]);
			_mm512_storeu_pd(&bk[(i+0)*MR+j*col*MR], x0);
			_mm512_storeu_pd(&bk[(i+0)*MR+j*col*MR+8], x00);//*/
		}
	}
	// move pointers
	bk += q*col*MR;
